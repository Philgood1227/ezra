...
import { EmotionsWidget } from "@/components/parent/dashboard/emotions-widget";
...
const meta = {
  title: "Parent/Dashboard/Emotions Widget",
  component: EmotionsWidget,
  args: {
    daily,
    moodMessage: "Semaine plutot ensoleillee",
  },
  tags: ["autodocs"],
} satisfies Meta<typeof EmotionsWidget>;
