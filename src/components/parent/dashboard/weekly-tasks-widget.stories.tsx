...
import { WeeklyTasksWidget } from "@/components/parent/dashboard/weekly-tasks-widget";
...
const meta = {
  title: "Parent/Dashboard/Weekly Tasks Widget",
  component: WeeklyTasksWidget,
  args: {
    daily,
  },
  tags: ["autodocs"],
} satisfies Meta<typeof WeeklyTasksWidget>;
